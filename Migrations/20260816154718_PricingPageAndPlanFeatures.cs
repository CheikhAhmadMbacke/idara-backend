        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("""
                ...
                VALUES (1,
                    ...
                    'Idara équipe les daara et écoles coraniques du Sénégal : élèves, classes, présences, suivi du Coran, paiement des mensualités et gestion financière. Le prix dépend uniquement du nombre d''élèves inscrits.',
                    'إدارة برنامج لتسيير الدارات والمدارس القرآنية في السنغال: التلاميذ، الفصول، الحضور، متابعة القرآن، دفع الأقساط والتسيير المالي. السعر يعتمد فقط على عدد التلاميذ المسجلين.',
                    '+221 76 363 53 27',
